    ...
    <div className="bg-blue-950 py-4">
      <div className="container mx-auto flex items-center justify-between px-4">
        <div className="flex items-center">
          ...
          <div className="flex items-center">
            <Link to='/Banker'   className="text-white font-semibold text-lg mr-6">Home</Link>
            
          </div>
        </div>
        <div className="flex items-center">
          <Link to="/Bankerprofile" className="text-white font-semibold mr-4">Profile</Link>
