...
function AccountApplicationForm(){
      ...
      const FormTitles = [ "Account Information", "Your Documents"];
      ...
      const PageDisplay = () => {
        if (page === 0) {
        return <AccountPersonalInfo formData={formData} setFormData={setFormData} />;
        } 
         else {
        return <DocumentsInfo formData={formData} setFormData={setFormData} />;
        }
      };
